...
public interface MarketService {
     ...
     * @return
     */
    JSONArray getCandles(String symbol, String start, String end,Long startTime,Long endTime, String granularity) throws IOException;
     ...
     * @return
     */
    OpenInterestApiDto getOpenInterestApi(String symbol) throws IOException;
     ...
     * @throws IOException
     */
    HistoricalFundingRate getNewHistoricalFundingRateApi(String symbol, String pageIndex, String pageSize) throws IOException;
