...
public class SpotWebSocketConfig {
    ...
    // weex coin webSocket url china area:wss://ws.weexapi.com/spot/v1/stream,International:wss://ws.weex.com/spot/v1/stream
    private static final String SERVICE_URL = "wss://ws.weex.com/spot/v1/stream";
    // api key
